...
void CWeaponMagazined::Load	(LPCSTR section)
{
	...
	if (pSettings->line_exist(section, "snd_reload_partly"))
		HUD_SOUND::LoadSound(section, "snd_reload_partly", sndReloadPartly, m_eSoundReloadPartly);
	else HUD_SOUND::LoadSound(section, "snd_reload", sndReloadPartly, m_eSoundReloadPartly);
...
{
	if (!IsJammedReloading() & !IsPartlyReloading())
